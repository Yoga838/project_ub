                    ...
                    <div className='grid grid-cols-12 2xl:gap-14 xl:gap-14 md:gap-7 gap-y-5'>
                            ...
                            <div className='flex justify-center border-0 2xl:w-[377px] xl:w-[377px] 2xl:h-[259px] xl:h-[259px] md:w-[300px] md:h-[220px] w-[300px] h-[220px] bg-white drop-shadow-sm rounded-[15px] p-5'>
                                <div>
                                    <div className='flex items-center justify-center gap-5'>
                                        <Notebook className='2xl:w-7 xl:w-7 md:w-5 2xl:h-7 xl:h-7 md:h-5 text-gray-800'/>
                                        <h7 className='font-medium text-gray-800 2xl:text-lg xl:text-lg md:text-sm text-sm'>Paperless Administration</h7>
                                    </div>
                                    <div className=''>
                                        <div className='flex items-center my-8 gap-2.5'>
                                            ...
                                            <p className='2xl:text-sm xl:text-sm md:text-xs text-xs text-gray-800/70'>Mengurangi ketergantungan pada dokumen fisik dengan sistem berbasis digital.</p>
                                        </div>
                                        <div className='flex items-center gap-2.5'>
                                            <div className='2xl:w-12 xl:w-12 md:w-5 2xl:h-12 xl:h-12 md:h-5 flex justify-center items-center'>
                                                <CircleArrowRight className='text-gray-800' />
                                            </div>
                                            <p className='2xl:text-sm xl:text-sm md:text-xs text-xs text-gray-800/70'>Menerapkan tanda tangan elektronik dan sistem persetujuan online.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className='2xl:col-span-4 xl:col-span-4 md:col-span-6 col-span-12'>
                            <div className='flex justify-center border-0 2xl:w-[377px] xl:w-[377px] 2xl:h-[259px] xl:h-[259px] md:w-[300px] md:h-[220px] w-[300px] h-[220px] bg-white drop-shadow-sm rounded-[15px] p-5'>
                                <div>
                                    <div className='flex items-center justify-center gap-5'>
                                        <ChartNoAxesColumnIncreasing className='2xl:w-7 xl:w-7 md:w-5 2xl:h-7 xl:h-7 md:h-5 text-gray-800'/>
                                        <h7 className='font-medium text-gray-800 2xl:text-lg xl:text-lg md:text-sm text-sm'>Portal Akademik yang Interaktif</h7>
                                    </div>
                                    <div className=''>
                                        <div className='flex items-center my-8 gap-2.5'>
                                            <div className='2xl:w-12 xl:w-12 md:w-5 2xl:h-12 xl:h-12 md:h-5 flex justify-center items-center'>
                                            ...
                                            <p className='2xl:text-sm xl:text-sm md:text-xs text-xs text-gray-800/70'>Mengembangkan portal akademik dengan fitur yang lebih responsif dan mudah digunakan.</p>
                                        </div>
                                        <div className='flex items-center gap-2.5'>
                                            <div className='2xl:w-12 xl:w-12 md:w-5 2xl:h-12 xl:h-12 md:h-5 flex justify-center items-center'>
                                                <CircleArrowRight className='text-gray-800' />
                                            </div>
                                            <p className='2xl:text-sm xl:text-sm md:text-xs text-xs text-gray-800/70'>Menyediakan fitur tracking progres akademik mahasiswa secara real-time.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='flex justify-center border-0 2xl:w-[377px] xl:w-[377px] 2xl:h-[259px] xl:h-[259px] md:w-[300px] md:h-[220px] w-[300px] h-[220px] bg-white drop-shadow-sm rounded-[15px] p-5'>
                                <div>
                                    <div className='flex items-center justify-center gap-5'>
                                        ...
                                        <h7 className='font-medium text-gray-800 2xl:text-lg xl:text-lg md:text-sm text-sm'>Absensi Digital</h7>
                                    </div>
                                    <div className=''>
                                        <div className='flex items-center my-8 gap-2.5'>
                                            <div className='2xl:w-12 xl:w-12 md:w-5 2xl:h-12 xl:h-12 md:h-5 flex justify-center items-center'>
                                            ...
                                            <p className='2xl:text-sm xl:text-sm md:text-xs text-xs text-gray-800/70'>Absensi Digital untuk Dosen dan Mahasiswa.</p>
                                        </div>
                                        <div className='flex items-center gap-2.5'>
                                            <div className='2xl:w-12 xl:w-12 md:w-5 2xl:h-12 xl:h-12 md:h-5 flex justify-center items-center'>
                                                <CircleArrowRight className='text-gray-800' />
