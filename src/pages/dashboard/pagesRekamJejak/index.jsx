        ...
        {dataTentangSaya.map((item) => (
          ...
          >
            ...
            <div className="flex w-full gap-2 mt-3 md:mt-0 md:w-auto">
              <button className="flex items-center justify-center gap-1 w-full md:w-auto px-6 py-1 text-sm text-white bg-[#1867A3] rounded hover:bg-[#145b91]">
                Edit
              </button>
              <button className="flex items-center justify-center w-full gap-1 px-6 py-1 text-sm text-gray-700 border border-gray-300 rounded md:w-auto hover:bg-gray-100">
                Hapus
              </button>
            </div>
          </div>
