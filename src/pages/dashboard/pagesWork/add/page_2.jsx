    ...
    <div className="my-10">
      <div className="">
        <div className="">
          <div>
            <FormInput
              label="Judul Sub-Program 1"
              name="judul_sub_program_1"
              value={formData.judul_sub_program_1}
              onChange={handleChange}
              placeholder="Judul Sub-Program 1"
              maxlength={20}
            />
            <p className="text-right text-sm mt-1">
              {formData.judul_sub_program_1.length}/20 Karakter
            </p>
          </div>
          <div className="my-14">
            <FormDesc
